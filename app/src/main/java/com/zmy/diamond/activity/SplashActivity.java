        ...
        PermissionUtils.permission(PermissionConstants.PHONE, PermissionConstants.LOCATION, PermissionConstants.STORAGE)
                .rationale(new PermissionUtils.OnRationaleListener() {
                    ...
                    public void rationale(final ShouldRequest shouldRequest) {
                        MyUtlis.showRationaleDialog(SplashActivity.this, shouldRequest);
                    }
                })
                .callback(new PermissionUtils.FullCallback() {
                    ...
                    public void onGranted(List<String> permissionsGranted) {
                        ...
                        if (AppConstant.DEBUG) {
                            ...
                            if (null == myAlertView) {
                                View view = View.inflate(SplashActivity.this, R.layout.view_debug_mode, null);

                                final EditText edit_view = (EditText) view.findViewById(R.id.edit_view);

                                String tip = "1.请输入正确的ip+port\n2.如果不输入,默认为:\nhttp://139.199.154.179:8080";
                                myAlertView = new MyAlertView("Debug模式", tip, null, new String[]{getString(R.string.hint_confirm)}, null, SplashActivity.this,
                    ...
                    public void onDenied(List<String> permissionsDeniedForever,
                        ...
                        if (!permissionsDeniedForever.isEmpty()) {
                            MyUtlis.showOpenAppSettingDialog(SplashActivity.this);
                        }

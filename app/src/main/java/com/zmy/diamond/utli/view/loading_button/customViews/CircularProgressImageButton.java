package com.zmy.diamond.utli.view.loading_button.customViews;
...
import com.zmy.diamond.utli.view.loading_button.animatedDrawables.CircularAnimatedDrawable;
import com.zmy.diamond.utli.view.loading_button.animatedDrawables.CircularRevealAnimatedDrawable;
import com.zmy.diamond.utli.view.loading_button.interfaces.AnimatedButton;
...
public class CircularProgressImageButton extends AppCompatImageButton implements AnimatedButton, CustomizableByCode {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if(attrs == null) {
            drawables = CircularProgressButton.loadGradientDrawable(MyUtlis.getDrawable(getContext(), R.drawable.shape_default));
        } else{
    ...
    /**
     * Method called to startCollect the animation. Morphs in to a ball and then starts a loading spinner.
     */

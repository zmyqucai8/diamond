 ...
 *
 *
 * 注: 在AlertView的基础上,修改了源码, 在点击后不自动关闭. 仅此而已,其他都相同
 */
public class MyAlertView {
    ...
    public MyAlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener){
...
//            dismiss();
    ...
    public static class Builder {
        ...
        public MyAlertView build() {
            return new MyAlertView(this);
        }
    }
}
